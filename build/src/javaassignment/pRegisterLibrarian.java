 ...
 * @author johar
 */
public class pRegisterLibrarian extends javax.swing.JFrame {

    /**
     * Creates new form MainMenu
     */
    public pRegisterLibrarian() {
        initComponents();
        AutoLibrarianID();
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Register Librarian");
        ...
        jLabel20.setText("Add Librarian");
                ...
                .addGroup(pnlBookInfo1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(pnlBookInfo1Layout.createSequentialGroup()
                        ...
                        .addGroup(pnlBookInfo1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtLibrarianID, javax.swing.GroupLayout.DEFAULT_SIZE, 136, Short.MAX_VALUE)
    ...
    String filename; 
    String ID, password, firstName, lastName, email, phoneNumber, State;
    
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
         try{

            filename = "src\\DB\\librarian_t.txt";
            ...
            if (IsEmpty == false){
                ...
                outputFile.println(ID + ":" + password + ":" + firstName + ":" + lastName + ":" + email + ":" + phoneNumber + ":" + State );
                ...
                Librarian lb = new Librarian(ID, password, firstName, lastName, email, phoneNumber, State);
            
                JOptionPane.showMessageDialog(null, lb.toString(), "Adding Succesful!",  JOptionPane.PLAIN_MESSAGE );
    ...
    String dir;
     private void AutoLibrarianID(){
        ...
        try {
            ...
            File librariantxt = new File(dir + "librarian_t.txt");
            Scanner inputFile;
            try {
                String lastBookID;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pRegisterLibrarian.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new pRegisterLibrarian().setVisible(true);
            }
        });
    }
